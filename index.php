...
// ==========================================
// 1. AMBIL DATA MEMPELAI DARI DATABASE
// ==========================================

// Ambil data mempelai wanita
...
// ==========================================
// 2. PROSES FORM RSVP (SUBMIT DATA)
// ==========================================
...
// Menyiapkan nama panggilan untuk title & sampul
$panggilan_wanita = isset($wanita['nama']) ? htmlspecialchars(explode(' ', trim($wanita['nama']))[0]) : 'Dinda';
$panggilan_pria   = isset($pria['nama']) ? htmlspecialchars(explode(' ', trim($pria['nama']))[0]) : 'Rizky';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Undangan Pernikahan <?= $panggilan_wanita; ?> & <?= $panggilan_pria; ?></title>
    ...
    <style>
        ...
        * { 
        ...
        .event-item:first-child { 
            border-right: 1px solid rgba(74, 93, 78, 0.15); 
        }
    ...
    <div class="main-card">
        <?php if (!$buka): ?>
            <div class="cover-wrapper">
                <h1><?= $panggilan_wanita; ?> & <?= $panggilan_pria; ?></h1>
                <div class="cover-date">12 . 09 . 2026</div>
                
                <div class="guest-box">
                    <span class="form-label">Kepada Yth:</span>
                    <h3 style="font-family: 'Playfair Display'; font-size: 1.4rem;">
                        <?= isset($_GET['to']) ? htmlspecialchars($_GET['to']) : 'TAMU UNDANGAN'; ?>
                    </h3>
                </div>
                
                <a href="?buka=true<?= isset($_GET['to']) ? '&to=' . urlencode($_GET['to']) : ''; ?>" class="btn" id="btnBukaUndangan">
                    Buka Undangan
                </a>
            </div>
        <?php else: ?>
            <div class="content-container">
                ...
                <div class="events-section">
                    <div class="grid-2" style="margin-bottom: 15px;">
                        <div class="event-item">
                            <h4>Akad Nikah</h4>
                            <p>08:00 - 10:00 WIB<br><b>Hotel Mulia</b><br>Jakarta</p>
                        </div>
                        <div class="event-item">
                            <h4>Resepsi</h4>
                            <p>11:00 - Selesai<br><b>Hotel Mulia</b><br>Jakarta</p>
                        </div>
                    </div>
                    <a href="https://www.google.com/maps?q=Hotel+Mulia+Senayan" target="_blank" class="btn" style="padding: 8px 20px;">
                ...
                <div class="rsvp-form-container">
                    <?php if ($success): ?>
                        <p style="color: var(--primary); font-size: 0.75rem; text-align:center; margin-bottom:10px; font-weight:600;">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" name="submit" class="btn" style="width:100%; justify-content:center;">
                            Kirim Konfirmasi
                        </button>
                    </form>
                </div>
                
                <div style="margin-top: 30px; font-size: 0.65rem; letter-spacing: 2px; color: #5a625c;">
                    <?= strtoupper($panggilan_wanita); ?> & <?= strtoupper($panggilan_pria); ?> — © 2026
                </div>
            </div>
        <?php endif; ?>
    </div>
