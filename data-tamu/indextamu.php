...
<title>Data Tamu - Admin Dashboard</title>
...
/* Ketika Navbar Aktif di HP (Slide Down Mendorong Konten) */
.navbar.active {
    max-height: 500px;
    padding: 15px 20px;
}
...
<nav class="navbar" id="sidebar">
    ...
    <div class="nav-menu">
        <a href="indextamu.php" class="active"><i class='bx bx-user'></i><span>Data Tamu</span></a>
        <a href="../data-users/datapengguna.php"><i class='bx bx-group'></i><span>Data Pengguna</span></a>
        <a href="../nma-mempelai/indexmempelai.php"><i class='bx bx-group'></i><span>Data mempelai</span></a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        } elseif ($status == 'tidak hadir' || $status == 'tidak') {
                            echo '<span class="badge badge-tidak">Tidak Hadir</span>';
                        } else {
                            echo '<span class="badge badge-ragu">' . htmlspecialchars($item['kehadiran']) . '</span>';
                        }
                        ?>
                    </td>
                    ...
                    <td class="actions">
                        <a href="edittamu.php?id=<?= $item['id']; ?>" class="edit-btn">Edit</a>
                        <a href="hapustamu.php?id=<?= $item['id']; ?>" class="delete-btn" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
...
// Reset class otomatis saat resolusi ukuran layar berubah (mencegah bug layout)
