...
<head>
    ...
    <title>Data Mempelai - Admin Dashboard</title>
...
<div class="main-content">
    ...
    <a href="tambahmempelai.php" class="add"><i class='bx bx-plus'></i> Tambah Data</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a href="hapusmempelai.php?id=<?= $item['id']; ?>" class="delete-btn" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
