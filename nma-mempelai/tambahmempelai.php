...
<head>
    ...
    <title>Tambah Data Mempelai - Admin Dashboard</title>
...
<div class="main-content">
    <h2>Tambah Data Mempelai</h2>

    <div class="form-card">
        <form method="post">
            <div class="form-group">
                <label for="nama">Nama Mempelai / Orang Tua</label>
                <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukkan nama lengkap..." value="<?= isset($_POST['nama']) ? htmlspecialchars($_POST['nama']) : ''; ?>" required>
            </div>
            ...
            <div class="btn-group">
                <button type="submit" name="simpan" class="btn btn-submit"><i class='bx bx-save'></i> Simpan</button>
